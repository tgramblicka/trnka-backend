...
CREATE TABLE examination_block (id BIGINT NOT NULL, allowed_retries INT DEFAULT NULL NULL, audio VARCHAR(255) NULL, complexity BIGINT DEFAULT NULL NULL, name VARCHAR(255) NULL, timeout BIGINT DEFAULT NULL NULL, type INT DEFAULT NULL NULL, CONSTRAINT PK_EXAMINATION_BLOCK PRIMARY KEY (id));

CREATE TABLE examination_step (id BIGINT NOT NULL, preserve_order BIT DEFAULT 0 NULL, brail_character_id BIGINT NOT NULL, examination_block_id BIGINT DEFAULT NULL NULL, CONSTRAINT PK_EXAMINATION_STEP PRIMARY KEY (id));

CREATE TABLE student (id BIGINT NOT NULL, device_identification_code VARCHAR(255) NULL, user_id BIGINT DEFAULT NULL NULL, CONSTRAINT PK_STUDENT PRIMARY KEY (id));
...
CREATE INDEX FKk5m148xqefonqw7bgnpm0snwj ON student(user_id);
CREATE INDEX FKpb6g6pahj1mr2ijg92r7m1xlh ON teacher(user_id);
CREATE INDEX FKrg7nxjlvm7ak0gvuhwgr96v21 ON examination_step(examination_block_id);
...
ALTER TABLE student ADD CONSTRAINT FKk5m148xqefonqw7bgnpm0snwj FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE examination_step ADD CONSTRAINT FKrg7nxjlvm7ak0gvuhwgr96v21 FOREIGN KEY (examination_block_id) REFERENCES examination_block (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
