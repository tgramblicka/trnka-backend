...
CREATE TABLE student (id BIGINT NOT NULL, device_identification_code VARCHAR(255) NULL, device_login_count INT NULL, course_id BIGINT NOT NULL, CONSTRAINT PK_STUDENT PRIMARY KEY (id));
