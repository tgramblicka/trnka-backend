...
public class AdminService {
    ...
    private ModelAndView getUiForEdit(User user,
                                      String infoMsg,
                                      List<String> errors,
                                      String pwdInfoMsg,
    ...
    private ModelAndView getUi(UserModel model,
    ...
    private PasswordModel toPwdModel(final User user,
    ...
    private UserModel toModel(final User user,
                              String infoMsg,
    ...
    private User toEntity(final UserModel model,
                          final User user) {
    ...
    private ModelAndView updateUser(UserModel model) {
        ...
        User savedUser = userService.updateUserFromDetachedEntity(user);
    ...
    private List<String> validateUsername(String newUsername,
                                          String oldUsername) {
    ...
    private ModelAndView createUser(UserModel model) {
        ...
        User savedUser = userService.createNewUser(model.getUsername(), passwordEncoder.encode(defaultPwd), model.getType());
        return getUi(toModel(savedUser, MSG_USR_CREATED, Collections.emptyList()), toPwdModel(savedUser, null, Collections.emptyList()));
    }
    ...
    public ModelAndView updatePassword(final PasswordModel model) {
        ...
        return getUiForEdit(savedUser, null, Collections.emptyList(), MSG_PWD_CHANGED, pwdErrors);
    }
}
