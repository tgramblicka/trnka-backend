...
public class CourseUiController {
  ...
  public static final String PATH_BRAIL_DELETE = "/brail/delete";
  ...
  public ModelAndView createCourse(@ModelAttribute CourseModel dto) {
    return courseService.createOrUpdate(dto);
  }

  @PostMapping(consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE, path = PATH_BRAIL_UP)
  ...
  @PostMapping(consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE, path = PATH_BRAIL_DOWN)
  ...
  @DeleteMapping(consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE, path = PATH_BRAIL_DELETE)
  public ModelAndView deleteExaminationStep(@RequestBody ExaminationStepReorderDto dto) {
    return examinationStepService.deleteExaminationStep(dto);
  }
